...
public interface ColorScheme {
    ...
    ColorScheme DOMINANT = new ColorScheme() {
        @Override
    ...
    ColorScheme PRIMARY = new ColorScheme() {
        @Override
        public Color lighten_5() {
    ...
    ColorScheme SECONDARY = new ColorScheme() {
        @Override
        public Color lighten_5() {
    ...
    ColorScheme ACCENT = new ColorScheme() {
        @Override
        public Color lighten_5() {
    ...
    ColorScheme SUCCESS = new ColorScheme() {
        @Override
        public Color lighten_5() {
    ...
    ColorScheme WARNING = new ColorScheme() {
        @Override
        public Color lighten_5() {
    ...
    ColorScheme INFO = new ColorScheme() {
        @Override
        public Color lighten_5() {
