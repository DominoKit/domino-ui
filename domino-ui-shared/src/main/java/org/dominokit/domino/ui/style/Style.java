...
public class Style<E extends HTMLElement, T extends IsElement<E>> implements IsElement<E> {
  ...
  public Style<E, T> removeClass(String... cssClasses) {
    if (nonNull(cssClasses) && cssClasses.length > 0) element.classList.remove(cssClasses);
    return this;
  }
  ...
  /**
   * use {@link org.dominokit.domino.ui.utils.BaseDominoElement#elevate(Elevation)} with elevation
   * level of {@link Elevation#NONE}
   */
  @Deprecated
  ...
  /**
   * use {@link org.dominokit.domino.ui.utils.BaseDominoElement#elevate(Elevation)} with elevation
   * level of {@link Elevation#LEVEL_1}
   */
  @Deprecated
