...
public abstract class BaseDominoElement<E extends HTMLElement, T extends IsElement<E>>
   ...
   *     org.dominokit.domino.ui.shaded.style.Waves} effect
   */
  @Override
  @Editor.Ignore
