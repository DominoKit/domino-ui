...
abstract class BasePagination<T extends BasePagination<T>> extends BaseDominoElement<HTMLElement, T> implements HasPagination {
    ...
    abstract void moveToPage(int page, boolean silent);
