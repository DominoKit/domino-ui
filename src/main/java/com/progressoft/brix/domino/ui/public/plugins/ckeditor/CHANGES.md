...
* [#14667](http://dev.ckeditor.com/ticket/14667): [IE] Fixed: Removing badgeBackground color from selected text removes badgeBackground color from the whole paragraph.
...
* [#13361](http://dev.ckeditor.com/ticket/13361): Fixed: Skin images fail when the site path includes parentheses because the `badgeBackground-image` path needs single quotes around the URL value.
