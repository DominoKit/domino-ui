...
/**
 * An implementation og the {@link AbstractDropMenuItem} for a menu item that can have a main text
 * and a description {@inheritDoc}
 */
public class SimpleDropMenuItem<V> extends AbstractDropMenuItem<V, SimpleDropMenuItem<V>> {
  ...
  public static <V> SimpleDropMenuItem<V> create(String text) {
    return new SimpleDropMenuItem<>(text);
  }

  public static <V> SimpleDropMenuItem<V> create(String text, String description) {
    return new SimpleDropMenuItem<>(text, description);
  }

  public SimpleDropMenuItem(String text) {
    this(text, null);
  }

  public SimpleDropMenuItem(String text, String description) {
