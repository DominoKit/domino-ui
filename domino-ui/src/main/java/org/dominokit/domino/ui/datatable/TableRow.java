...
public class TableRow<T> extends BaseDominoElement<HTMLTableRowElement, TableRow<T>>
    ...
    private Set<SelectionListener<? super TableRow<T>, ? super TableRow<T>>> selectionListeners = new HashSet<>();
    private Set<SelectionListener<? super TableRow<T>, ? super TableRow<T>>> deselectionListeners = new HashSet<>();
    ...
    @Override
    public Set<SelectionListener<? super TableRow<T>, ? super TableRow<T>>> getDeselectionListeners() {
