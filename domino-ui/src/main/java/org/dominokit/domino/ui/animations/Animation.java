 ...
 * <p>
 * This class is used to animate an HTMLElement and provide a set of method to configure the animation,
 * also provide some method to add some callback during different animation phases
 * <p>For example: </p>
 * <pre>
 *
...
public class Animation {
     ...
     * @param infinite boolean repeat this animation infinitely or until {@link Animation#stop()}  is called
     */
    ...
    /**
     * static factory method to create an animation for an {@link IsElement}
     * this method will create an animation for the {@link HTMLElement} wrapped in the {@link IsElement}
     *
    ...
    /**
     * sets the time the animation should wait before actually animate the element after {@link Animation#animate()} is called
     *
    ...
    /**
     * sets the animation as infinite so once the animation starts it will repeat infinitely or until {@link Animation#stop()} is called
     *
     * @return same instance
     */
    ...
    /**
     * sets the animation to repeat for a specific number of times or until {@link Animation#stop()} is called.
     * @param repeatCount double the number of times the animation to be repeated e.g <pre>2.5</pre> repeats the animation 2 times and a half
     * @return same instance
     */
    ...
    /**
     * An implementation of this interface will provide some logic to be executed right after the animation is completed
     */
    @FunctionalInterface
    ...
    /**
     * An implementation of this interface will provide some logic to be executed right before the animation starts
     */
    @FunctionalInterface
