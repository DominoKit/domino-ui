...
//   * {@inheritDoc}
//   *
//   * <p>the plugin will create a group based on the GroupSupplier and will append rows to the
// first
...
//  }
//
//  public static class DataGroup<T> implements RowMeta {
//
...
//                      FlexItem.create()
//                          .styler(style ->
// style.setLineHeight(px.of(35)).setPaddingLeft(px.of(10)))
//                          .setFlexGrow(1)
