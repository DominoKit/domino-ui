 ...
 * <p>
 *     Accordion component can work in different mode to give the user the ability to show and hide content
 *     an accordion can multiple {@link AccordionPanel} and the user click on a panel to show/hide its content
 *     by default only one panel will be open and the other panels will be closed unless the multi open flag is set
 *     which will allow more than one panel to be open at once.
 *
 *     <p>Multi open false</p>
 *     <pre>
 *         Accordion.create()
 *                 .appendChild(
...
public class Accordion extends BaseDominoElement<HTMLDivElement, Accordion> {
    ...
    /**
     * Adds an accordion panel to the accordion and allow overriding the accordion panel colors with the colors from the Accordion
     * @param panel {@link AccordionPanel}
    ...
    /**
     * Toggles the Accordion panel open state. if it is open it will be closed and if closed it will open
     * @param panel {@link AccordionPanel}
     */
