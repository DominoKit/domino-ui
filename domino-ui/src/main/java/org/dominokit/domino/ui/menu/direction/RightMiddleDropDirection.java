...
/** RightMiddleDropDirection class. */
public class RightMiddleDropDirection implements DropDirection {
  ...
  public DropDirection position(DropDirectionContext context) {
    ...
    if (spaceChecker.hasSpaceOnRight()) {
      return showOnRightMiddle(context, source);
  ...
  private DropDirection showOnRightMiddle(DropDirectionContext context, Element source) {
  ...
  public void cleanSelf(Element source) {
    dui_dd_right_middle.remove(source);
