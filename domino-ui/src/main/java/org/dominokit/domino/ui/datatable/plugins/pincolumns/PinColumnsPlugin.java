 ...
 *
 * pinning a column to the left will also pin all columns that are to the left of that column to left too
 * pinning a column to the right will also pin all columns that are to the right of that column to the right.
 * pinning a column in a column group will pin all columns in that group.
 *
