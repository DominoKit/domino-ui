...
public class Win8LinearLoader extends BaseLoader<Win8LinearLoader>
  ...
  private final HTMLDivElement progress1 =
      div().css(WAIT_ME_PROGRESS_ELEM_1).add(div().style("background-color:#555")).element();
  private final HTMLDivElement progress2 =
      div().css(WAIT_ME_PROGRESS_ELEM_2).add(div().style("background-color:#555")).element();
  private final HTMLDivElement progress3 =
      div().css(WAIT_ME_PROGRESS_ELEM_3).add(div().style("background-color:#555")).element();
  private final HTMLDivElement progress4 =
      div().css(WAIT_ME_PROGRESS_ELEM_4).add(div().style("background-color:#555")).element();
  private final HTMLDivElement progress5 =
      div().css(WAIT_ME_PROGRESS_ELEM_5).add(div().style("background-color:#555")).element();
