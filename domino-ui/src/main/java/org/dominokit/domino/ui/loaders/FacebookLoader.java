...
/**
 * A loader component that displays a Facebook-like loader animation to indicate progress or
 * loading.
 *
 * <p>This loader consists of three bouncing elements that form a Facebook-like animation.
 *
 * <p>Example usage:
 *
 * <pre>
 * FacebookLoader loader = FacebookLoader.create();
...
public class FacebookLoader extends BaseLoader<FacebookLoader>
  ...
  private final DivElement loader =
      div()
          .addCss(dui_waitme_progress, dui_waitme_facebook)
  ...
  /** Initializes a new instance of the {@code FacebookLoader} class. */
  public FacebookLoader() {
    init(this);
  }

  /**
   * Creates a new instance of the {@code FacebookLoader} class.
   *
   * @return A new {@code FacebookLoader} instance.
   */
