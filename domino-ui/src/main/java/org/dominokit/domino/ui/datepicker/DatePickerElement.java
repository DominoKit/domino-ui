...
class DatePickerElement implements Selectable<DatePickerElement> {
    ...
    /**
     * Creates a day header element at a specific {@code index}, the element will be added to the list of days of a month
     *
     ...
     * <p>
     * Each day element takes a handler to be called when it is selected
     *
