 ...
 */
public class SuggestBox<T> extends AbstractValueBox<SuggestBox<T>, HTMLInputElement, T>
    implements HasSelectionHandler<SuggestBox<T>, SuggestItem<T>> {
  ...
  private boolean applyMissingValue(T value) {
    ...
    Optional<SuggestItem<T>> messingSuggestion =
