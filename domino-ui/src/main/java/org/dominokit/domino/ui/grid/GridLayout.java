...
/**
 * A layout which is a 12 columns grid based with a required content section and 4 other optional sections Header, Footer, Left and Right.
 * <p>
 * More information can be found in <a href="https://developer.mozilla.org/en-US/docs/Learn/CSS/CSS_layout/Grids">MDN official documentation</a>
 * <p>
...
public class GridLayout extends BaseDominoElement<HTMLDivElement, GridLayout> {
    ...
    /**
     * Change the size of the right section, changing the right section can be to cover up to 6 columns
     *
     * @param sectionSpan the number of columns to cover
     * @param spanUp true to make the right section sized to the top of the layout even if the header exists, false to position it based on the header
     * @param spanDown true to make the right section sized to the bottom of the layout even if the footer exists, false to position it based on the footer
     * @return same instance
     */
     ...
     *
     * @param sectionSpan the number of columns to cover
     * @param spanUp true to make the left section sized to the top of the layout even if the header exists, false to position it based on the header
     * @param spanDown true to make the left section sized to the bottom of the layout even if the footer exists, false to position it based on the footer
     * @return same instance
     */
