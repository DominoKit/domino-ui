...
public class AbstractDialog<T extends AbstractDialog<T>> extends BaseDominoElement<HTMLDivElement, T> implements DialogStyles {
    ...
    public AbstractDialog() {
        element = DominoElement.div()
                ...
                .appendChild(modalElement = DominoElement.div()
                        .addCss(dui_modal)
                        .appendChild(contentElement = DominoElement.div()
                                .addCss(dui_dialog_content)
                                .appendChild(bodyElement = DominoElement.div().addCss(dui_dialog_body))
                        )
                )
        ;
        init((T) this);
        ...
        headerElement = LazyChild.of(DominoElement.div()
                .addCss(dui_dialog_header)
                .setAttribute("role", "tab"), modalElement);

        titleElement = LazyChild.of(DominoElement.span().addCss(dui_dialog_title), headerElement);
        contentHeader = LazyChild.of(DominoElement.div().addCss(dui_dialog_content_header), contentElement);
