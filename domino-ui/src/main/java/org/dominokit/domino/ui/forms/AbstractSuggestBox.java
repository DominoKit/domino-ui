...
public abstract class AbstractSuggestBox<T, V, S extends Option<T>,  C extends AbstractSuggestBox<T, V, S, C>> extends AbstractFormElement<AbstractSuggestBox<T, V, S, C>, V>
    ...
    private boolean applyMissingEntry(String value) {
        SuggestBoxStore.MissingEntryProvider<T, S> messingEntryProvider = store.getMessingEntryProvider();
    ...
    public interface SuggestValueRenderer<T, V, S extends Option<T>, C extends AbstractSuggestBox<T, V, S, C>> {
        HTMLElement element(C select, Option<T> option);
    }

    private static class SuggestAutoValidator<T, V, S extends Option<T>, C extends AbstractSuggestBox<T, V, S, C>>
