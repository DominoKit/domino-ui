...
public class DropDownMenu extends BaseDominoElement<HTMLDivElement, DropDownMenu> implements HasBackground<DropDownMenu> {
    ...
    private final DominoElement<HTMLDivElement> element = DominoElement.of(div().css(DropDownStyles.DROPDOWN));
    private final DominoElement<HTMLUListElement> menuElement = DominoElement.of(ul().css(DropDownStyles.DROPDOWN_MENU));
    private final HTMLElement targetElement;
    private DropDownPosition position = DropDownPosition.BOTTOM;
    private final DominoElement<HTMLDivElement> titleContainer = DominoElement.of(div()).addCss(DropDownStyles.DROPDOWN_TITLE_CONTAINER);
    private final DominoElement<HTMLDivElement> searchContainer = DominoElement.of(div().css(DropDownStyles.DROPDOWN_SEARCH_CONTAINER));
    private final DominoElement<HTMLInputElement> searchBox = DominoElement.of(input("text")
    ...
    /**
     * Sets if the menu is searchable or not. Searchable menu will filter the actions based on the search criteria provided in the search element
     *
    ...
    /**
     * Sets the no search result element which will be shown when there is no results found according to the search criteria
     *
    ...
    /**
     * Sets the search filter strategy that will be called to filter the actions based on the search value
     *
    ...
    public interface AppendStrategy {
        ...
        /**
         * {@code FIRST} strategy means that the menu will be added at the first index of the target element
         */
    ...
    public interface SearchFilter {
        /**
         * Checks if the {@code dropdownAction} should be displayed or not based on the {@code searchText}
         *
