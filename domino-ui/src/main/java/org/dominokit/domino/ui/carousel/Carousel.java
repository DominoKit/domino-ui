...
public class Carousel extends BaseDominoElement<HTMLDivElement, Carousel> {
    ...
    public Carousel() {
        ...
        element = DominoElement.div()
          ...
          .appendChild(prevElement = DominoElement.a()
          ...
          .appendChild(nextElement = DominoElement.a()
    ...
    private void removeMotionStyles() {
        activeSlide.removeCss(slide_left).removeCss(slide_right).removeCss(slide_next).removeCss(slide_prev);
        activeSlide.deActivate();
        targetSlide.removeCss(slide_left).removeCss(slide_right).removeCss(slide_next).removeCss(slide_prev);
    ...
    public Carousel withIndicatorsElement(ChildHandler<Carousel, DominoElement<HTMLOListElement>> handler){
        handler.apply(this, indicatorsElement);
        return this;
    }

    public Carousel withPreviousElement(ChildHandler<Carousel, DominoElement<HTMLAnchorElement>> handler){
        handler.apply(this, prevElement);
        return this;
    }

    public Carousel withNextElement(ChildHandler<Carousel, DominoElement<HTMLAnchorElement>> handler){
