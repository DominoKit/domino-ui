 ...
 * <p>
 * This component displays locations with the ability to navigate between them and highlighting the current one,
 * each location can have text and icon with a click listener that will be called when user clicks on it.
 * <p>
...
public class Breadcrumb extends BaseDominoElement<HTMLOListElement, Breadcrumb> implements HasBackground<Breadcrumb> {
    ...
    private final DominoElement<HTMLOListElement> element = DominoElement.of(ol()
     ...
     * <ul>
     *     <li>
     *          Given {@code removeTail} is true and having 4 locations as follows:
     * <p>
     *          <strong>A</strong> -> <strong>B</strong> -> <strong>C</strong> -> <strong>D</strong>
     * <p>
     *          when selecting location <strong>B</strong>, then the new locations will be as follows:
     * <p>
     *          <strong>A</strong> -> <strong><u>B</u></strong>
     *     </li>
     *     <li>
     *          Given {@code removeTail} is false and having 4 locations as follows:
     * <p>
     *          <strong>A</strong> -> <strong>B</strong> -> <strong>C</strong> -> <strong>D</strong>
     * <p>
     *          when selecting location <strong>B</strong>, then the new locations will be as follows:
     * <p>
     *          <strong>A</strong> -> <strong><u>B</u></strong> -> <strong>C</strong> -> <strong>D</strong>
     *     </li>
     * </ul>
     *
