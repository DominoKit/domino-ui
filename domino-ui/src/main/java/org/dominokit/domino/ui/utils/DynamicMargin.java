...
/** Dynamic margin utility classes following Domino UI spacing conventions. */
public final class DynamicMargin {

  public static final DynamicCssDefinition MARGIN = definition("dui-m", "margin");
  public static final DynamicCssDefinition TOP = definition("dui-m-t", "margin-top");
  public static final DynamicCssDefinition RIGHT = definition("dui-m-r", "margin-right");
  public static final DynamicCssDefinition BOTTOM = definition("dui-m-b", "margin-bottom");
  public static final DynamicCssDefinition LEFT = definition("dui-m-l", "margin-left");
  public static final DynamicCssDefinition X = definition("dui-m-x", "margin-left", "margin-right");
  public static final DynamicCssDefinition Y = definition("dui-m-y", "margin-top", "margin-bottom");

  private DynamicMargin() {}

  public static CssClass of(String value) {
    return cssClass(MARGIN, value);
  }

  public static CssClass of(Unit unit, Number value) {
    return cssClass(MARGIN, unit, value);
  }
