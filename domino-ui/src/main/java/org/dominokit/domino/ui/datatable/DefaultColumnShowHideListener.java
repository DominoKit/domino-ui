...
/**
 * This implementation is default to show/hide any element whenever the table column visibility is changed
 * <p>
 *     e.g
 *     remove the column name a from a list of columns
 * </p>
 */
public class DefaultColumnShowHideListener implements ColumnShowHideListener {
     ...
     * @param element {@link HTMLElement}
     * @param permanent boolean, if true make this listener permanent so it wont be removed when the listeners are cleared
     * @return new {@link DefaultColumnShowHideListener}
     */
