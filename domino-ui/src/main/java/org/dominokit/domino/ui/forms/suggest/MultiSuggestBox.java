...
public class MultiSuggestBox<V, E extends IsElement<?>, O extends Option<V, E, O>>
    ...
    public static <V, E extends IsElement<?>, O extends Option<V, E, O>> MultiSuggestBox<V, E, O> create(SuggestionsStore<V, E, O> store) {
        return new MultiSuggestBox<>(store);
    }

    public static <V, E extends IsElement<?>, O extends Option<V, E, O>> MultiSuggestBox<V, E, O> create(String label, SuggestionsStore<V, E, O> store) {
    ...
    protected MultiSuggestBox<V, E, O> clearValue(boolean silent) {
        if (!selectedOptions.isEmpty()) {
            ...
            optionsMenu.withPauseSelectionListenersToggle(
                    true,
                    field -> new ArrayList<>(selectedOptions).forEach(this::onOptionDeselected));
