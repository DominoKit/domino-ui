...
/**
 * A component which provides an abstract level of the CSS flex item which will inherit the styles for the CSS flex item by default
 * <p>
...
public class FlexItem extends BaseDominoElement<HTMLDivElement, FlexItem> {
    ...
    /**
     * Sets the order of this item inside the layout, the order of the item calculates the position of the item inside the layout
     *
     ...
     * <p>
     * More information can be found in <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex-grow">MDN official documentation</a>
     *
     ...
     * <p>
     * More information can be found in <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex-shrink">MDN official documentation</a>
     *
     ...
     * <p>
     * More information can be found in <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/flex-basis">MDN official documentation</a>
     *
